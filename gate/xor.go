...
var _ cc.Gater = (*Xor)(nil)

type Xor struct {
	cc.Gate
}

func NewXorGate(name string, inputs []cc.Element, outputs []cc.Element) *Xor {
	return &Xor{
		Gate: cc.Gate{
			Name:    name,
			Inputs:  inputs,
...
func (g *Xor) Init(ctx context.Context, client *redis.Client) {
...
func (g *Xor) Handler(index int, value bool) (results []bool, changed bool) {
